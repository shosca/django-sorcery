...
htmlhelp_basename = "DjangoSorcery"
...
latex_documents = [(master_doc, "DjangoSorcery.tex", "Django Sorcery Documentation", "Serkan Hosca", "manual")]

# -- Options for manual page output ---------------------------------------

# One entry per manual page. List of tuples
# (source start file, name, description, authors, manual section).
man_pages = [(master_doc, "djangosorcery", "Django Sorcery Documentation", [author], 1)]
